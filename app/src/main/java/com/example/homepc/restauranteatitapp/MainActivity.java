...
//        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_pasta) {
            Toast.makeText(getApplicationContext(),"Pasta Fragment",Toast.LENGTH_SHORT).show();
           ...
           android.support.v4.app.FragmentTransaction fragmentTransaction =
            ...
            Toast.makeText(getApplicationContext(),"Italian Fragment",Toast.LENGTH_SHORT).show();
           ...
           fragmentTransaction.commit();
            ...
            Toast.makeText(getApplicationContext(),"Continental Fragment ",Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(getApplicationContext(),"Pizza Fragment",Toast.LENGTH_SHORT).show();
